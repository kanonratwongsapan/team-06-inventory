...
src/models.py
src/notifiers.py
Notifier protocol + EmailNotifier, SMSNotifier + NotifierFactory
src/service.py
InventoryService (business logic เท่านั้น)
## Coding Convention
...
## ข้อห้าม (สำคัญมาก)
ห้ามให้ Inventory Service รู้จัก EmailNotifier/SMSNotifier โดยตรง
